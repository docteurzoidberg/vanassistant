...
class ScoutEyeModel : public Model {
  public:
    ...
    ScoutEyeModel(GFX3D::vec3d offset) : offset(offset), Model(&verts, &faces){ 
      SetupModel();
    }
    ...
    void Update(float elapsedTime) override {
      ...
      GFX3D::mat4x4 matRotX = GFX3D::Math::Mat_MakeRotationX(pitch);
      ...
      translationMatrix.m[1][3] += offset.y;
      translationMatrix.m[2][3] += offset.z;
    }
...
class ScoutMicModel : public Model {
  public:
    ...
    void Update(float elapsedTime) override {
      ...
      GFX3D::mat4x4 matRotX = GFX3D::Math::Mat_MakeRotationX(currentAngle);
      rotationMatrix = GFX3D::Math::Mat_MultiplyMatrix(rotationMatrix, matRotX);
    }
...
class ScoutJawModel : public Model {
  public:
    ...
    void Update(float elapsedTime) override {
      ...
      //rotationMatrix = rotationMatrix * matRotX;
      GFX3D::mat4x4 matRotX = GFX3D::Math::Mat_MakeRotationX(angle);
      rotationMatrix = GFX3D::Math::Mat_MultiplyMatrix(rotationMatrix, matRotX);
    }
...
class Scout {
  ...
  private:
    ...
    GFX3D::mat4x4 rotationMatrix = GFX3D::Math::Mat_MakeIdentity();
    GFX3D::mat4x4 translationMatrix = GFX3D::Math::Mat_MakeIdentity();
    ...
    void _updateAnimation(float elapsedTime) {
      ...
      GFX3D::mat4x4 matrixRotX = GFX3D::Math::Mat_MakeRotationX(animCurrent.rX);
