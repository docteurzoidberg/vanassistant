const uint8_t Solid_Mono4pt7bBitmaps[] PROGMEM = {
...
const GFXglyph Solid_Mono4pt7bGlyphs[] PROGMEM = {
  {     0,   1,   1,   5,    0,    0 },   // 0x20 ' '
  {     1,   1,   5,   5,    2,   -4 },   // 0x21 '!'
  {     2,   3,   3,   5,    1,   -4 },   // 0x22 '"'
  {     4,   2,   4,   4,    1,   -3 },   // 0x23 '#'
...
const GFXfont Solid_Mono4pt7b PROGMEM = {
  (uint8_t  *)Solid_Mono4pt7bBitmaps,
  (GFXglyph *)Solid_Mono4pt7bGlyphs,
  0x20, 0x7E, 11 };
