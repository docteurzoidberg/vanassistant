...
// Définir les sommets du vaisseau spatial
const std::vector<std::tuple<float, float, float>> spaceshipVertices = {
...
// Définir les faces du vaisseau spatial
const std::vector<std::tuple<int,int,int>> spaceshipFaces = {
    {21, 52, 12},
    {6, 13, 8},
    {5, 23, 1},
    {7, 1, 3},
